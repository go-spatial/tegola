...
var testExtents = []geom.Extent{
	/* 00 */ geom.Extent{0, 0, 10, 10},
	/* 01 */ geom.Extent{2, 2, 9, 9},
	/* 02 */ geom.Extent{-1, -1, 11, 11},
	/* 03 */ geom.Extent{-2, -2, 12, 12},
	/* 04 */ geom.Extent{-3, -3, 13, 13},

	/* 05 */ geom.Extent{-4, -4, 14, 14},
	/* 06 */ geom.Extent{5, 1, 7, 3},
	/* 07 */ geom.Extent{0, 5, 2, 7},
	/* 08 */ geom.Extent{0, 5, 2, 7},
	/* 09 */ geom.Extent{5, 2, 11, 9},

	/* 10 */ geom.Extent{-1, -1, 11, 11},
	/* 11 */ geom.Extent{0, 0, 4096, 4096},
}
